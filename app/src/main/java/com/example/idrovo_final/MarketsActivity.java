...
public class MarketsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RVadapter Adapter = new RVadapter(this, s1, s2, images);
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.home:
                        Toast.makeText(MarketsActivity.this, "Home",Toast.LENGTH_LONG).show();
                        startActivity(new Intent(getApplicationContext(), MainActivity.class));
                        break;
                    case R.id.markets:
                        Toast.makeText(MarketsActivity.this, "Markets",Toast.LENGTH_LONG).show();
                        startActivity(new Intent(getApplicationContext(), MarketsActivity.class));
                        System.out.println("Inside Markets - MarketsActivity.java");
                        //getMarketInfo("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=false");

                        break;
                    case R.id.news:
                        Toast.makeText(MarketsActivity.this, "News",Toast.LENGTH_LONG).show();
                        startActivity(new Intent(getApplicationContext(), NewsActivity.class));
                        break;
                    case R.id.favs:
                        Toast.makeText(MarketsActivity.this, "Favs",Toast.LENGTH_LONG).show();
...
// TODO: DO NOT FORGET ABOUT THIS
    public static MarketData getMarketInstance() {
        return data;
    }

    public void getMarketInfo(String url){
        System.out.println(url);
        System.out.println("Inside getMarketInfo");
        ...
        //JsonArrayRequest getRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            //public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    Intent intent = new Intent(MarketsActivity.this, DisplayActivity.class);
